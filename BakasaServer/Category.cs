namespace BakasaServer
{
    public class Category
    {
        ...
        public static List<Category> GetCategories()
        {
            ...
            {
                new Category("Jobs",new List<string>(){"طبيب", "معلم", "مهندس", "ممرض", "ضابط شرطة", "رجل إطفاء", "ميكانيكي", "كهربائي", "طاهٍ", "طيار",
...
"مهندس برمجيات", "أخصائي تسويق", "مدير مشروع", "أستاذ جامعي", "مدير موارد بشرية", "محلل مالي", "فني مختبر", "خبير اقتصادي", "رائد أعمال", "مهندس مدني" }
                ...
                new Category("Foods", new List<string>(){"بيتزا", "برجر", "كبسة", "مندي", "سوشي", "شاورما", "فلافل", "كباب", "باستا", "سمبوسة",
...
new Category("Electronics", new List<string>(){"هاتف", "كمبيوتر", "لابتوب", "كاميرا", "سماعات", "ميكروفون", "لوحة مفاتيح", "فأرة", "تلفزيون", "طابعة",
...
new Category("League of Legends Characters", new List<string>(){"أهري", "ياسو", "زايا", "راكان", "جين", "كاتارينا", "إزريال", "داريوس", "لي سين", "ثريش",
...
new Category("Places", new List<string>(){"الحمام", "صالة البولينج", "المدرسة", "المكتبة", "الجامعة", "المستشفى", "الحديقة", "السوبرماركت", "المقهى", "المطعم",
...
new Category("جماد",new List<string>(){"كتاب", "قلم", "كرسي", "طاولة", "ساعة", "مرآة", "مصباح", "حقيبة", "زجاجة", "نافذة",
...
new Category("حيوان", new List<string>(){"أسد", "نمر", "فيل", "زرافة", "ذئب", "ثعلب", "دب", "نسر", "بومة", "غزال",
...
new Category("أكلات",new List<string>(){"كبسة", "مندي", "مشاوي", "ورق عنب", "محشي", "ملوخية", "برياني", "مقلوبة", "شاورما", "حمص",
